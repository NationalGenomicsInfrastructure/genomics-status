...
class Application(tornado.web.Application):
    def __init__(self, settings):
        handlers = [
            ...
            ("/projects/open", OpenProjectsHandler),
            ("/projects/pending", PendingProjectsHandler),
            ("/projects/ongoing", OngoingProjectsHandler),
            ("/projects/reception_control", ReceptionControlProjectsHandler),
            ("/projects/closed", ClosedProjectsHandler),
