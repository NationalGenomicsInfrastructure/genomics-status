...
from status.pricing import PricingDateToVersionDataHandler, PricingExchangeRatesDataHandler, \
    ...
    PricingDataHandler, PricingDraftDataHandler, GenerateQuoteHandler
...
from status.projects import CaliperImageHandler, CharonProjectHandler, \
    ...
    ImagesDownloadHandler, LastModifiedProjects
...
class Application(tornado.web.Application):
    def __init__(self, settings):
        ...
        handlers = [
            ...
            ("/api/v1/last_modified_project", LastModifiedProjects),
