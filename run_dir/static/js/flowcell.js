...
load_running_notes({'flowcell_id_reference': flowcell_id_reference});
// from links.js
load_links({'flowcell_id_reference': flowcell_id_reference});
get_link_url({'flowcell_id_reference': flowcell_id_reference});
